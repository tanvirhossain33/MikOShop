...
<div class="new_arrivals">
	<div class="container">
		...
		<p>This Our new product.Some of our product are already come here and some are going on.To find the latest design and quality product you have to visit our site regularly. </p>
		<div class="new_grids">
			<div class="col-md-4 new-gd-left">
				...
				<div class="wed-brand simpleCart_shelfItem">
					...
					<p><i>1000৳</i> <span class="item_price">500৳</span><a class="item_add hvr-outline-out button2" href="#">add to cart </a></p>
				</div>
			</div>
				...
				<div class="img-box"><img src="{{asset('public/frontEnd/')}}/images/p1.jpg" alt="image" class="img-responsive zoom-img"></div>
					<div class="info-box">
						<div class="info-content simpleCart_shelfItem">
									...
									<p><span class="item_price">22500৳</span></p>
									<span class="separator"></span>
